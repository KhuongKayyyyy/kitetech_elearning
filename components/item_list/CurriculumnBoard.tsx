...
import GeneratedCurriColumn from "./CurriSemesterColumn";

interface GeneratedCurriBoardProps {
  subjects: CurriculumnSubjectModel[];
}

export default function GeneratedCurriBoard({
  subjects,
}: GeneratedCurriBoardProps) {
  ...
  const totalCredits = subjects.reduce(
    (sum, subject) => sum + subject.TotalCredits,
    0
  );
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-600 text-xl max-w-2xl mx-auto leading-relaxed'>
              Comprehensive overview of your academic journey with interactive
              semester planning
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8'>
            {sortedSemesters.map((semester, index) => {
              ...
              const semesterName =
                subjects[0]?.SemesterName || `Semester ${semester}`;
            ...
            <div className='relative mb-8'>
              ...
              <div className='absolute top-6 left-0 right-0 flex justify-between text-sm text-gray-600'>
                ...
                <span className='font-medium text-primary'>
                  {sortedSemesters.length}/8 Semesters
                </span>
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <span className='font-medium text-green-600'>
                      {sortedSemesters.length > 0
                        ? Math.round(totalCredits / sortedSemesters.length)
                        : 0}
                    </span>
                  </div>
                </div>
