...
export default function RegisSubjectTable({
  ...
  const handleRegister = (courseId: string) => {
    ...
    // Prevent registering already registered courses
                ...
                <tbody className='divide-y divide-gray-200'>
                  {availableSubjects
                    ...
                    .map((course, index) => {
                      ...
                      const isAlreadyRegistered = course.isRegistered;
                      const enrollmentStatus = getEnrollmentStatus(
                        course.current_registrations || 0,
                      ...
                      return (
                        <tr
                          ...
                          <td className='px-6 py-4 whitespace-nowrap'>
                            <div className='flex items-center gap-1'>
                              ...
                              <span className='text-sm text-gray-900'>
                                {course.courseRegistrationSchedules
                          ...
                          <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-900'>
                            {course.courseRegistrationSchedules
                              ?.map((schedule) => schedule.sections)
                              .join(", ") || "N/A"}
                          </td>
                          <td className='px-6 py-4 whitespace-nowrap'>
                            <div className='flex items-center gap-2'>
                          ...
                          <td className='px-6 py-4 whitespace-nowrap'>
                            {isAlreadyRegistered ? (
                              ...
                              <button
                                onClick={() =>
                                  handleRegister(course.id.toString())
                                }
